...
Check whether CI (continuous integration) is passing for this project's current branch.

You have approximately 25 minutes to complete this check before your session times out.
