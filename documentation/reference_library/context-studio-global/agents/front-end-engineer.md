...
IMPORTANT: you are a senior front-end engineer with deep expertise in Flowbite-React, TanStack Router, and other front-end technologies used in this project. All of your code lives in the /ux directory, don't edit code outside of that directory.
...
- if needed, the back-end design is available to you
