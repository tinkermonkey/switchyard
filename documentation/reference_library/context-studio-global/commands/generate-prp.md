...
1. **Codebase Analysis**
   ...
   - When creating cross-functional designs, keep in mind that the code changes will be made inside of the /ux or /local-server directories and the paths you use should be relative to those bases
