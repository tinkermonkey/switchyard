...
IMPORTANT: Ensure that your feedback is appropriate for the tech stack for the project and the deliverable being built and the requirements being implemented. Don't offer irrelevant advice. If provided a github issue or pull request, leave your feedback as a comment using the github cli.
