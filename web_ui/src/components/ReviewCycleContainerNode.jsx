...
/**
 * Container node for a review cycle.
 * Renders as a purple dashed bounding box with a header bar.
 * Contains: [Review Cycle Started] [Iteration 1] [Iteration 2] … [Review Cycle Completed]
 ...
 *   endTime         {string}
 */
const BORDER_COLOR = '#9333ea'
const BG_COLOR = 'rgba(147, 51, 234, 0.14)'

const ReviewCycleContainerNode = ({ data }) => {
  const {
    cycleId,
    label = 'Review Cycle',
    iterationCount = 0,
    ...
    >
      ...
      {isCollapsed && (
        ...
        >
          ...
          <div style={{ fontSize: 24, fontWeight: 700, color: '#e9d5ff' }}>
            {iterationCount}×
          </div>
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                height: 16,
                ...corner,
                ...(corner.borderTop ? { borderTop: '2px solid rgba(147,51,234,0.6)' } : {}),
                ...(corner.borderBottom ? { borderBottom: '2px solid rgba(147,51,234,0.6)' } : {}),
                ...(corner.borderLeft ? { borderLeft: '2px solid rgba(147,51,234,0.6)' } : {}),
                ...(corner.borderRight ? { borderRight: '2px solid rgba(147,51,234,0.6)' } : {}),
              }}
            />
          ))}
        </>
