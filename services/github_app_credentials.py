...
from each other: github_api_client is imported by github_app's own accounting
hook, so either direction closes an import cycle. This module is deliberately
tiny and dependency-free so both can depend on it instead.
"""
